...
class TestErrors < Minitest::Test
  ...
  def test_all_error_classes_can_be_raised
    ...
    assert_raises(Vibe::ValidationError) { raise Vibe::ValidationError, "validation error" }
    assert_raises(Vibe::ConfigurationError) { raise Vibe::ConfigurationError, "config error" }
