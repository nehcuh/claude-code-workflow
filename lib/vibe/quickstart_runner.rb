  ...
  module QuickstartRunner
    ...
    def run_quickstart(options = {})
      ...
      if is_update
        ...
        overwrite_prompt = 'Would you like to overwrite it with the latest Vibe template?'
        unless options[:force] || ask_yes_no(overwrite_prompt)
      ...
      begin
        ...
        puts(
          "\n✅ Success! Claude Code workflow has been " \
        ...
        puts 'Next steps:'
        puts "1. Open #{File.join(claude_home,
                                  'CLAUDE.md')} and customize these sections:"
